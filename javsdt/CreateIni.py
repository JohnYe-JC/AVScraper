...
try:
    ...
    config_settings.set("原影片文件的性质", "有码素人无视多余的字母数字", "xhd1080、mm616、fhd-1080、FENGNIAO151.VIP、kpxvs.com、sokxv.com、hhd800.com、UUN-56、UUN-59、hjd2048.com")
    config_settings.set("原影片文件的性质", "无码无视多余的字母数字", "1080p、caribbean、carib、1pondo、1pon、fhd、all、tokyo-hot、tokyohot、3xplanet、full、psk.la")
    ...
    config_settings.set("其他设置", "javlibrary网址", "https://www.k51r.com/")
